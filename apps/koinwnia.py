...
layout = html.Div(children=[
    ...
    html.Div([
        html.Div(children=[
            ...
            dcc.Graph(figure=fig_13, style= {'display':'inline-block'}),
            dcc.Graph(figure=fig_15, style= {'display':'inline-block', 'vertical-align': 'top'}),
            dcc.Graph(figure=fig_12, style= {'display':'inline-block'}),
